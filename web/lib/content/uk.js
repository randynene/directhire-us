/* UK variant of the copy, pulled from the design handoff's
   "Direct Hire Website - UK.dc.html". Same shape as ./us.js so every
   section component can render either just by swapping which content
   object it's given — see app/uk/page.jsx. */
...
export const uk = {
  ...
  hero: {
    ...
    shortlist: {
      ...
      candidates: [
        { role: 'Senior AI Engineer', meta: 'Manchester · 9 yrs', skills: ['Go', 'Postgres', 'AWS', 'Kafka'], salary: '£95,000' },
        { role: 'Senior Full-Stack Engineer', meta: 'Bristol · 7 yrs', skills: ['TypeScript', 'React', 'Node', 'GraphQL'], salary: '£85,000' },
      ],
    },
  },
  ...
  explainer: {
    ...
    /* Only the UK prototype tightens this section's top padding to 80px
       (via [data-sec-tight]) — the US file keeps the uniform 140px. */
    tight: true,
  },
  ...
  process: {
    ...
    stage3: {
      ...
      report: {
        ...
        meta: 'Manchester · 9 yrs · Go, Postgres, AWS',
  ...
  pricing: {
    ...
    card: {
      ...
      rows: [
        { label: 'Example: senior engineer at £75,000', value: '£18,750' },
        { label: 'Paid to start the search, credited in full', value: '− £2,000' },
        { label: 'Due when they start', value: '£16,750', emphasis: true },
      ],
      footnote: 'Base salary only — we don’t take a percentage of bonus, equity or signing. If you don’t hire anyone, the £2,000 is all you’ve spent.',
    },
    why: {
      title: 'Why we ask for £2,000 up front',
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'What does it cost?', answer: '25% of first-year base salary. £2,000 to start the search, credited in full against the fee.' },
      ...
      { question: 'Do you do this in the US?', answer: 'Yes — direct hire in the United States is available alongside UK permanent recruitment.' },
    ],
  },
  ...
  closing: {
    ...
    fineprint: '£2,000 to start, credited to the fee · 6-month replacement guarantee',
  },

  footer: {
    left: '© 2026 CloudEmployee. Direct hire — United Kingdom.',
    right: 'Also available: direct hire in the United States',
  },
  ...
  modal: {
    ...
    sentChecks: [
      ...
      '£2,000 to start, credited in full to the fee',
    ],
  },
};
